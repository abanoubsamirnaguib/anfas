...
const translations = {
  en: {
    ...
    cart: {
      ...
      orderSentInstagram: 'Order sent to Instagram successfully!',
      instagramCopied: 'Order details copied! Paste them in the Instagram chat.',
      instagramHint: 'Your order details will be copied to clipboard. Just paste them in the Instagram conversation.',
      suggestedHeading: 'Suggested Products',
      addToCart: 'Add',
      sendVia: 'Send order via',
      whatsapp: 'WhatsApp',
      instagram: 'Instagram',
      chooseChannel: 'Choose how to send your order',
    },
    product: {
      size: 'Select Size',
  ...
  ar: {
    ...
    cart: {
      ...
      orderSentInstagram: 'تم إرسال الطلب إلى انستجرام بنجاح!',
      instagramCopied: 'تم نسخ تفاصيل الطلب! الصقها في محادثة انستجرام.',
      instagramHint: 'سيتم نسخ تفاصيل طلبك تلقائياً. فقط الصقها في محادثة انستجرام.',
      suggestedHeading: 'منتجات مقترحة',
      addToCart: 'إضافة',
      sendVia: 'إرسال الطلب عبر',
      whatsapp: 'واتساب',
      instagram: 'انستجرام',
