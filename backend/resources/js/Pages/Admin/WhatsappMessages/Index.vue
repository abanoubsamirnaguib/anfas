        ...
        <template #header>
            <div class="flex flex-col lg:flex-row justify-between lg:items-center gap-3">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center gap-2 w-full lg:w-auto">
                    ...
                    <select v-model="filterForm.channel" class="rounded-md border-slate-700 bg-slate-950 text-slate-100 shadow-sm text-sm">
                        ...
                        <table class="min-w-[1180px] w-full divide-y divide-slate-800">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-slate-400 uppercase">Channel</th>
                            ...
                            <tbody class="divide-y divide-slate-800 bg-slate-900">
                                <tr v-for="msg in messages.data" :key="msg.id">
                                    ...
                                    <td class="px-6 py-4 text-sm">
                                        <span v-if="msg.channel === 'instagram'" class="px-2 inline-flex items-center gap-1 text-xs leading-5 font-semibold rounded-full bg-pink-100 text-pink-800">
                                        ...
                                        <span v-else class="px-2 inline-flex items-center gap-1 text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
